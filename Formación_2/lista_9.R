...
# LISTAS, GUARDAN DIFERENTES OBJETOS. LAS LISTAS SON USADAS POR OTRAS FUNCIONES
# PARA GUARDAR DUS RESULTADOS
# CASO DE USO REGRESION LINEAL

# crear lista en R FUNDION LIST
...
# Seleccionar vector de la lista. se usa [[]] para la seleccion
lista_curso[["vector"]]

# Seleccionar el tercer elemento del vector de la lista
lista_curso[["vector"]][3] # se usa solo [] para el elemento
